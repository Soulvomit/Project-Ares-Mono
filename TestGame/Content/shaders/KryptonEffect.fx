...
technique TextureToTarget_Add
{
	pass Pass1
	{
		...
		VertexShader = compile vs_4_0 VS_ScreenCopy();
		PixelShader = compile ps_4_0 PS_ScreenCopy();
	}
};
...
technique SimpleTexture
{
	pass Pass1
	{
		...
		VertexShader = compile vs_4_0 VS_SimpleTexture();
		PixelShader = compile ps_4_0 PS_SimpleTexture();
	}
};
...
technique LightTexture
{
	pass Pass1
	{
		...
		VertexShader = compile vs_4_0 VS_SimpleTexture();
		PixelShader = compile ps_4_0 PS_LightTexture();
	}
};
...
technique PointLight_Shadow
{
	pass Shadow
	{
		...
		VertexShader = compile vs_4_0 VS_PointLight_Shadow();
		PixelShader = compile ps_4_0 PS_PointLight_Shadow();
	}
};
...
technique PointLight_ShadowWithIllumination
{
	pass Shadow_Illumination
	{
		...
		VertexShader = compile vs_4_0 VS_Shadow_HullIllumination();
		PixelShader = compile ps_4_0 PS_Shadow_HullIllumination();
	}
...
technique Blur
{
    pass HorizontalBlur
    {
		...
		VertexShader = compile vs_4_0 VS_ScreenCopy();
        PixelShader = compile ps_4_0 PS_BlurH();
    }
    ...
    pass VerticalBlur
    {
		...
		VertexShader = compile vs_4_0 VS_ScreenCopy();
        PixelShader = compile ps_4_0 PS_BlurV();
    }
}
...
technique PointLight_Shadow_Fast
{
	...
	pass ClearAlpha
	{
		...
		VertexShader = compile vs_4_0 VS_ScreenCopy();
		PixelShader = compile ps_4_0 PS_ClearTarget();
	}
